...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_slider_a = new wxSlider( this, wxID_ANY, 1, 1, 100, wxDefaultPosition, wxDefaultSize, wxSL_BOTH|wxSL_HORIZONTAL );
	...
	m_slider_b = new wxSlider( this, wxID_ANY, 1, 1, 100, wxDefaultPosition, wxDefaultSize, wxSL_BOTH|wxSL_HORIZONTAL );
	...
	m_slider_c = new wxSlider( this, wxID_ANY, 1, 1, 100, wxDefaultPosition, wxDefaultSize, wxSL_BOTH|wxSL_HORIZONTAL );
	...
	m_slider_x = new wxSlider( this, wxID_ANY, 0, 1, 360, wxDefaultPosition, wxDefaultSize, wxSL_BOTH|wxSL_HORIZONTAL );
	m_slider_x->SetMaxSize( wxSize( 215,35 ) );

	bSizer10->Add( m_slider_x, 1, wxALL, 5 );

	m_staticText_x = new wxStaticText( this, wxID_ANY, wxT("1"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_slider_y = new wxSlider( this, wxID_ANY, 0, 1, 360, wxDefaultPosition, wxDefaultSize, wxSL_BOTH|wxSL_HORIZONTAL );
	m_slider_y->SetMaxSize( wxSize( 215,35 ) );

	bSizer11->Add( m_slider_y, 1, wxALL, 5 );

	m_staticText_y = new wxStaticText( this, wxID_ANY, wxT("1"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_slider_z = new wxSlider( this, wxID_ANY, 0, 1, 360, wxDefaultPosition, wxDefaultSize, wxSL_BOTH|wxSL_HORIZONTAL );
	m_slider_z->SetMaxSize( wxSize( 215,35 ) );

	bSizer12->Add( m_slider_z, 1, wxALL, 5 );

	m_staticText_z = new wxStaticText( this, wxID_ANY, wxT("1"), wxDefaultPosition, wxDefaultSize, 0 );
